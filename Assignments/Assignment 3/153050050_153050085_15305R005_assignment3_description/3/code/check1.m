function [origDataPoints,dataPoints,clusterCentroids,pointsToClusters] = check1(numDimensions,useKNNToGetH)
        ...
        function[dataPoints] = getDataPoints(numPoints,numDimensions)
                numClasses = randi([2,20],1); % generate a random number between 2 and 8
                dataPoints = [];
                curNumberOfPoints = 0;
